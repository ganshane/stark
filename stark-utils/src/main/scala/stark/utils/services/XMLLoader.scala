...
object XmlLoader {
  ...
  def loadConfig[T <: Object](filePath: String,
                              ...
                              encoding: String = StarkUtilsConstants.UTF8_ENCODING)(implicit m: Manifest[T]): T = {
  ...
  def parseXML[T <: Object](content: String,
                            symbols: Map[String, String] = Map[String, String](),
                            encoding: String = StarkUtilsConstants.UTF8_ENCODING,
  ...
  def parseXML[T <: Object](is: InputStream, xsd: Option[InputStream])(implicit m: Manifest[T]): T = {
    ...
    try {
      ...
      //create io reader
      val reader = new InputStreamReader(is, StarkUtilsConstants.UTF8_ENCODING)
   ...
   * 把对象转化为XML文件
   */
  def toXml[T](obj: T, encoding: String = StarkUtilsConstants.UTF8_ENCODING): String = {
